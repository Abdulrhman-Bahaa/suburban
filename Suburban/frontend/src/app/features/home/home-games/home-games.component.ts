...
export class HomeGamesComponent {
  ...
  onWindowScroll() {
    ...
    console.log(
      `Scroll Top: ${scrollTop}, Viewport Height: ${viewportHeight}, Full Height: ${fullHeight}`,
    );
  ...
  heroSlides = [
    {
      title: "VINEWOOD'S FINEST",
      subtitle: 'Get the latest titles from the heart of the city.',
      buttonText: 'SHOP SPRING SALE',
      image: 'https://4kwallpapers.com/images/walls/thumbs_3t/24198.jpg',
    },
    {
      title: 'NIGHT CITY DEALS',
      subtitle: 'Upgrade your hardware with cybernetic discounts.',
      buttonText: 'VIEW BUNDLES',
      image: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co1vcf.jpg',
    },
    {
      title: 'LANDS BETWEEN',
      subtitle: 'Explore epic open worlds at a fraction of the cost.',
